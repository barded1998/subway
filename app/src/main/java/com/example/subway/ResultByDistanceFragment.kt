...
class ResultByDistanceFragment : Fragment() {
    ...
    public fun newInstance(page: Int, title: String?): ResultByDistanceFragment? {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(com.example.subway.R.layout.fragment_result_by_distance, container, false)
