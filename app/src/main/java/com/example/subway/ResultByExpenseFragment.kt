...
class ResultByExpenseFragment : Fragment() {
    ...
    public fun newInstance(page: Int, title: String?): ResultByExpenseFragment? {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(com.example.subway.R.layout.fragment_result_by_expense, container, false)
